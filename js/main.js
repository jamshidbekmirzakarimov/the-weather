...
const updateUi = (city) => {
    ...
    detailes.innerHTML =`
    <h5 class="mb-3 text-light"> ${city.name}, ${city.sys.country}</h5>
            <p class="mb-2 text-light">${city.weather[0].main}</p>
            <div class="display-4 mb-3 ">
                <span class="temp text-light">${Math.round(city.main.temp)}</span><span class"text-light">&deg;C</span>
            </div>
    `
